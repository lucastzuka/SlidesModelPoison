const SLIDES = [
  ...
  { id:"SLIDE4", w:1615, h:803, els:[
    {t:"fr", x:500, y:213, w:1115, h:540, bg:"#fbd3d8", r:36, els:[
      {t:"tx", x:385, y:48, w:610, text:"0,001%", font:"Fraunces", sz:160, wt:700, it:false, color:"#2d2d2d", align:"left"},
      {t:"rc", x:381, y:288, w:74, h:45, bg:"#ffe288"},
      {t:"tx", x:242, y:245, w:753, text:"de artigos falsos causou aumento de\n+5% em conselhos médicos prejudiciais.\nMédicos humanos não notaram a diferença", font:"Nunito", sz:34, wt:500, it:false, color:"#2d2d2d", align:"right", lh:"129%"},
      {t:"tx", x:242, y:449, w:753, text:"Nature Medicine. 2025", font:"Nunito", sz:24, wt:500, it:false, color:"#2d2d2d", align:"right"}
    ]},
    {t:"img", x:230, y:130, w:463, h:478, src:"images/s04_5-886.png"},
    ...
    {t:"tx", x:645, y:24, w:965, text:"E se a IA que você usou\nhoje já estiver envenenada?", font:"Fraunces", sz:84, wt:700, it:true, color:"#2d2d2d", align:"right", lh:"85px"}
  ]},
  ...
  // SLIDE 7
  { id:"SLIDE7", w:1600, h:594, els:[
    {t:"rc", x:989, y:386, w:611, h:45, bg:"#fff06e"},
    {t:"tx", x:688, y:33, w:896, text:"Não precisa invadir\na OpenAI", font:"Fraunces", sz:110, wt:700, it:true, color:"#2d2d2d", align:"right", lh:"112%"},
    {t:"tx", x:842, y:284, w:742, text:"Basta deixar o veneno onde o robô dela vai passar", font:"Fraunces", sz:64, wt:400, it:true, color:"#595959", align:"right"},
    {t:"img", x:0, y:0, w:891, h:594, src:"images/s07_12-221.png"}
  ]},
  ...
  { id:"SLIDE10", w:1678, h:1037, els:[
    ...
    {t:"img", x:61, y:462, w:571, h:266, r:25, src:"images/s10_16-20.png"},
    {t:"img", x:61, y:728, w:571, h:309, r:25, src:"images/s10_16-19.png"},
  ...
  { id:"SLIDE11", w:1680, h:782, els:[
    {t:"tx", x:0, y:0, w:1008, text:"Envenenar a coleta de dados", font:"Fraunces", sz:84, wt:700, it:true, color:"#2d2d2d", align:"left"},
  ...
  { id:"SLIDE12", w:1603, h:1341, els:[
    ...
    {t:"tx", x:64, y:201, w:1166, text:"A IA não distingue bem \"dado para ler\" de \"ordem para obedecer\"", font:"Nunito", sz:36, wt:700, it:false, color:"#2d2d2d", align:"left"},
  ...
  { id:"SLIDE14", w:1646, h:657, els:[
    ...
    {t:"tx", x:1219, y:196, w:427, text:"🦠 Moltbook\nem uma rede social de\nIAs autonomas um modelo doente contamina toda a comunidade", font:"Nunito", sz:28, wt:600, it:false, color:"#1a1a1a", align:"right"},
    {t:"img", x:576, y:414, w:701, h:243, src:"images/s14_21-231.png"}
  ]},

  // SLIDE 15
  { id:"SLIDE15", w:1522, h:677, els:[
    {t:"rc", x:43, y:154, w:161, h:363, bg:"#e6e0f5"},
    {t:"fr", x:149, y:174, w:1078, h:343, bg:"#e6e0f5", r:36, els:[
      {t:"tx", x:55, y:31, w:606, text:"Casos reais", font:"Fraunces", sz:128, wt:700, it:true, color:"#1a1a1a", align:"left"},
      {t:"rc", x:54, y:223, w:303, h:57, bg:"#ffe288"}
    ]},
    {t:"tx", x:211, y:354, w:624, text:"Já não é hipótese de laboratório\nEstá acontecendo em escala industrial", font:"Nunito", sz:36, wt:600, it:false, color:"#282828", align:"left", lh:"130%"},
    {t:"img", x:936, y:81, w:612, h:539, src:"images/s15_5-891.png"},
    {t:"tx", x:0, y:0, w:169, text:"!", font:"Fraunces", sz:549, wt:700, it:true, color:"#c7bde0", align:"left"}
  ]},
  ...
  { id:"SLIDE20", w:1477, h:533, els:[
    ...
    {t:"tx", x:665, y:74, w:812, text:"Modelpoison é ferramenta\nde manipulação de mercado\ne influência política", font:"Fraunces", sz:54, wt:700, it:true, color:"#1a1a1a", align:"left", lh:"114%"}
  ]},
  ...
  { id:"SLIDE22", w:1653, h:672, els:[
    ...
    {t:"tx", x:1, y:35, w:788, text:"A guerra pela verdade", font:"Fraunces", sz:84, wt:700, it:true, color:"#1a1a1a", align:"left"},
  ...
  { id:"SLIDE23", w:1674, h:946, els:[
    ...
    {t:"fr", x:0, y:190, w:538, h:324, bg:"#d2ebdf", r:36, els:[
      {t:"tx", x:46, y:44, w:446, text:"Filtrar antes do treino", font:"Nunito", sz:42, wt:600, it:false, color:"#3f8b70", align:"left", lh:"123%"},
      {t:"tx", x:46, y:134, w:446, text:"Validação automática + sanitização dos datasets.", font:"Nunito", sz:30, wt:600, it:false, color:"#1a1a1a", align:"left", lh:"140%"}
    ]},
    {t:"fr", x:568, y:190, w:538, h:324, bg:"#e6e0f5", r:36, els:[
      {t:"tx", x:46, y:44, w:446, text:"Registrar origem", font:"Nunito", sz:42, wt:600, it:false, color:"#6e5db0", align:"left"},
      {t:"tx", x:46, y:101, w:446, text:"Blockchain, ML-BOM e CycloneDX · certidão de nascimento dos dados.", font:"Nunito", sz:30, wt:600, it:false, color:"#1a1a1a", align:"left", lh:"140%"}
    ]},
    {t:"fr", x:1136, y:190, w:538, h:324, bg:"#fbd3d8", r:36, els:[
      {t:"tx", x:46, y:44, w:446, text:'"Vacina" controlada', font:"Nunito", sz:42, wt:600, it:false, color:"#a8456b", align:"left", lh:"123%"},
      {t:"tx", x:46, y:134, w:446, text:"Inocular veneno medido para criar resistência no modelo.", font:"Nunito", sz:30, wt:600, it:false, color:"#1a1a1a", align:"left", lh:"140%"},
      {t:"img", x:310, y:-23, w:177, h:332, src:"images/s23_5-1088.png"}
    ]},
    {t:"img", x:360, y:318, w:240, h:240, src:"images/s23_28-41.png"},
    ...
    {t:"fr", x:568, y:554, w:538, h:324, bg:"#fff2ce", r:36, els:[
      {t:"tx", x:46, y:44, w:446, text:"Red Team contínuo", font:"Nunito", sz:42, wt:600, it:false, color:"#7a5a00", align:"left", lh:"123%"},
      {t:"tx", x:46, y:134, w:446, text:"Ataques simulados sem parar + sandbox para treino novo.", font:"Nunito", sz:30, wt:600, it:false, color:"#1a1a1a", align:"left", lh:"140%"}
    ]},
    ...
    {t:"img", x:333, y:702, w:188, h:188, src:"images/s23_28-48.png"},
    {t:"img", x:1410, y:720, w:264, h:226, src:"images/s23_28-47.png"},
    {t:"img", x:847, y:381, w:289, h:433, src:"images/s23_5-1097.png"}
  ]},
  ...
  { id:"SLIDE26", w:1563, h:697, els:[
    ...
    {t:"tx", x:1347, y:115, w:216, text:"CONCLUSÃO", font:"Nunito", sz:34, wt:800, it:false, color:"#1a1a1a", align:"left"},
    {t:"tx", x:484, y:187, w:1079, text:"Um dos riscos da IA não é ela \"ganhar vida\"\nÉ ela ser ensinada a acreditar em mentiras", font:"Fraunces", sz:54, wt:700, it:true, color:"#1a1a1a", align:"right"},
    {t:"tx", x:711, y:321, w:852, text:"O conceito de envenenamento muda\ndependendo do lado que você está da história", font:"Nunito", sz:40, wt:700, it:false, color:"#2d2d2d", align:"right"}
  ]}
];
